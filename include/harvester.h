...
#define INTERFACE_DEVICES_WIFI_MLO_AVRO_FILENAME	"InterfaceDevicesWifi_MLO.avsc"
...
#define INTERFACE_DEVICES_WIFI_MLO_AVRO_FILENAME	"/usr/ccsp/harvester/InterfaceDevicesWifi_MLO.avsc"
